...
$c_LHello$.prototype.init___ = (function() {
  return this
});
$c_LHello$.prototype.sayHello__LRequest__sjs_js_Object__sjs_js_Function2__V = (function(request, context, callback) {
  var message = (((("Hello, " + $as_T(request.name)) + ". You're ") + $uI(request.age)) + " years old!");
  var response = new $c_LResponse().init___T__I(message, 42);
  callback(null, response.toJsObj__sjs_js_Object())
});
var $d_LHello$ = new $TypeData().initClass({
  LHello$: 0
}, false, "Hello$", {
  LHello$: 1,
  O: 1
});
$c_LHello$.prototype.$classData = $d_LHello$;
var $n_LHello$ = (void 0);
function $m_LHello$() {
  if ((!$n_LHello$)) {
    $n_LHello$ = new $c_LHello$().init___()
  };
  return $n_LHello$
}
/** @constructor */
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_LResponse() {
  $c_O.call(this);
  this.message$1 = null;
  this.secretNumber$1 = 0
}
$c_LResponse.prototype = new $h_O();
$c_LResponse.prototype.constructor = $c_LResponse;
/** @constructor */
function $h_LResponse() {
  /*<skip>*/
}
$h_LResponse.prototype = $c_LResponse.prototype;
$c_LResponse.prototype.toJsObj__sjs_js_Object = (function() {
  var s = this.message$1;
  var value = this.secretNumber$1;
  return {
    "message": s,
    "secretNumber": value
  }
});
$c_LResponse.prototype.productPrefix__T = (function() {
  return "Response"
});
$c_LResponse.prototype.productArity__I = (function() {
  return 2
});
$c_LResponse.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_LResponse.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LResponse.prototype.$$js$exported$prop$toJsObj__O = (function() {
  return this.toJsObj__sjs_js_Object()
});
$c_LResponse.prototype.$$js$exported$prop$message__O = (function() {
  return this.message$1
});
$c_LResponse.prototype.$$js$exported$prop$secretNumber__O = (function() {
  return this.secretNumber$1
});
$c_LResponse.prototype.init___T__I = (function(message, secretNumber) {
  this.message$1 = message;
  this.secretNumber$1 = secretNumber;
  return this
});
$c_LResponse.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.message$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.secretNumber$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_LResponse.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
Object.defineProperty($c_LResponse.prototype, "toJsObj", {
  "get": (function() {
    return this.$$js$exported$prop$toJsObj__O()
  }),
  "configurable": true
});
Object.defineProperty($c_LResponse.prototype, "secretNumber", {
  "get": (function() {
    return this.$$js$exported$prop$secretNumber__O()
  }),
  "configurable": true
});
Object.defineProperty($c_LResponse.prototype, "message", {
  "get": (function() {
    return this.$$js$exported$prop$message__O()
  }),
  "configurable": true
});
var $d_LResponse = new $TypeData().initClass({
  LResponse: 0
}, false, "Response", {
  LResponse: 1,
  O: 1,
...
$c_LResponse.prototype.$classData = $d_LResponse;
/** @constructor */
...
$e.sayHello = (function(arg$1, arg$2, arg$3) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  var prep2 = arg$3;
  $m_LHello$().sayHello__LRequest__sjs_js_Object__sjs_js_Function2__V(prep0, prep1, prep2)
});
