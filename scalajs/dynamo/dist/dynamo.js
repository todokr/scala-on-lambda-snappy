...
var $i_aws$002dsdk = require("aws-sdk");
/** @constructor */
function $c_O() {
  /*<skip>*/
}
...
/** @constructor */
function $c_LDynamoAccessor$() {
  $c_O.call(this);
  this.dynamoClient$1 = null
}
$c_LDynamoAccessor$.prototype = new $h_O();
$c_LDynamoAccessor$.prototype.constructor = $c_LDynamoAccessor$;
/** @constructor */
function $h_LDynamoAccessor$() {
  /*<skip>*/
}
$h_LDynamoAccessor$.prototype = $c_LDynamoAccessor$.prototype;
$c_LDynamoAccessor$.prototype.init___ = (function() {
  $n_LDynamoAccessor$ = this;
  this.dynamoClient$1 = new $i_aws$002dsdk.DynamoDB.DocumentClient();
  return this
});
$c_LDynamoAccessor$.prototype.handleRequest__LRequest__sjs_js_Object__sjs_js_Function2__V = (function(request, context, callback) {
  var jsx$6 = $m_sjs_js_Dictionary$();
  var jsx$5 = new $c_T2().init___O__O("TableName", "PriceHistory");
  var jsx$4 = new $c_T2().init___O__O("KeyConditionExpression", "#ji = :jobid");
  var jsx$2 = $m_sjs_js_Dictionary$();
  var array = [new $c_T2().init___O__O("#ji", "JobId")];
  var y = jsx$2.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var jsx$3 = new $c_T2().init___O__O("ExpressionAttributeNames", y);
  var jsx$1 = $m_sjs_js_Dictionary$();
  var y$1 = $as_T(request.jobId);
  var array$1 = [new $c_T2().init___O__O(":jobid", y$1)];
  var y$2 = jsx$1.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  var array$2 = [jsx$5, jsx$4, jsx$3, new $c_T2().init___O__O("ExpressionAttributeValues", y$2)];
  var param = jsx$6.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2));
  this.dynamoClient$1.query(param, (function(callback$1) {
    return (function(arg1$2, arg2$2) {
      return $m_LDynamoAccessor$().DynamoAccessor$$$anonfun$handleRequest$1__sjs_js_Object__sjs_js_Object__sjs_js_Function2__sjs_js_Any(arg1$2, arg2$2, callback$1)
    })
  })(callback))
});
$c_LDynamoAccessor$.prototype.DynamoAccessor$$$anonfun$handleRequest$1__sjs_js_Object__sjs_js_Object__sjs_js_Function2__sjs_js_Any = (function(err, data, callback$1) {
  if ((err !== null)) {
    var value = $asUnit(callback$1(null, err));
    return value
  } else {
    var value$1 = $asUnit(callback$1(null, data));
    return value$1
  }
});
var $d_LDynamoAccessor$ = new $TypeData().initClass({
  LDynamoAccessor$: 0
}, false, "DynamoAccessor$", {
  LDynamoAccessor$: 1,
  O: 1
});
$c_LDynamoAccessor$.prototype.$classData = $d_LDynamoAccessor$;
var $n_LDynamoAccessor$ = (void 0);
function $m_LDynamoAccessor$() {
  if ((!$n_LDynamoAccessor$)) {
    $n_LDynamoAccessor$ = new $c_LDynamoAccessor$().init___()
  };
  return $n_LDynamoAccessor$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_sjs_js_Dictionary$.prototype.apply__sc_Seq__sjs_js_Dictionary = (function(properties) {
  ...
  new $c_sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(properties, p).foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, result$1) {
...
$e.handleRequest = (function(arg$1, arg$2, arg$3) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  var prep2 = arg$3;
  $m_LDynamoAccessor$().handleRequest__LRequest__sjs_js_Object__sjs_js_Function2__V(prep0, prep1, prep2)
});
